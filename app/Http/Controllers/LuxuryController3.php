...
class LuxuryController3 extends Controller
{
    public function index()
    {
        ...
        return view('template3.index3', compact('headerFooter', 'homesetting', 'section1', 'section2', 'categories', 'products', 'testimonials', 'contactus'))
