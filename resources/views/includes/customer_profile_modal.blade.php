    ...
    <div class="space-y-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input id="phoneInput" type="text" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-pink-600" />
        </div>
      </div>
      <div>
        <label class="block text-sm font-medium">Address Line 1</label>
        <input id="address1Input" type="text" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-pink-600" />
      </div>
      <div>
        <label class="block text-sm font-medium">Address Line 2</label>
        <input id="address2Input" type="text" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-pink-600" />
      </div>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium">City</label>
          <input id="cityInput" type="text" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-pink-600" />
        </div>
        <div>
          <label class="block text-sm font-medium">State</label>
          <input id="stateInput" type="text" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-pink-600" />
        </div>
      </div>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium">Postal Code</label>
          <input id="postalCodeInput" type="text" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-pink-600" />
        </div>
        <div>
          <label class="block text-sm font-medium">Country</label>
          <input id="countryInput" type="text" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-pink-600" />
        </div>
      </div>
