                                                ...
                                                @foreach($items as $item)
                                                    <div class="cart-item py-3 flex flex-col sm:flex-row items-start sm:items-center justify-between text-sm" data-id="{{ $item->id }}">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <input type="number" id="quantity-{{$item->id}}" name="quantity" value="{{ $item->quantity }}" class="w-16 rounded-md border border-gray-300 py-1 text-left text-base font-medium leading-5 text-gray-700 shadow-sm focus:border-pink-500 focus:ring-1 focus:ring-pink-500 sm:text-sm" min="1">
                                                        </div>
