                        ...
                        <div class="wishlist-item flex items-center py-6" data-id="{{ $item->id }}">
                            ...
                            <div class="ml-4 flex flex-1 flex-col">
                                ...
                                <div class="flex flex-1 items-end justify-between text-sm mt-4">
                                    ...
                                    <div class="flex">
                                        <a href="{{ route('template3.single-product3.customer', ['headerFooterId' => $headerFooter->id, 'productId' => $item->product->id]) }}" class="add-to-cart-btn font-medium text-white bg-pink-600 hover:bg-pink-700 px-4 py-2 rounded-md">View Product</a>
                                    </div>
                                </div>
                            </div>
                        </div>
