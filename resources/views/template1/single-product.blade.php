@include('template1.head1')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="space-y-6">
                ...
                <div class="relative bg-purple-50 border border-purple-200 p-4 rounded-lg combo-offer-pulse overflow-hidden">
                    <canvas id="confetti-canvas-1" class="absolute top-0 left-0 w-full h-full z-10 pointer-events-none"></canvas>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const canvas = document.getElementById('confetti-canvas-1');
            if (canvas) {
