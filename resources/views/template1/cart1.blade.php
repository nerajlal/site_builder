        ...
        <div class="flex flex-col lg:flex-row -mx-4">
            ...
            <div class="w-full lg:w-1/3 px-4 mt-8 lg:mt-0">
                <div class="bg-white rounded-lg shadow-lg p-6 sticky top-24">
                    ...
                    <a href="{{ route('products.show', ['websiteId' => $headerFooter->id]) }}" class="block text-center mt-4 text-pink-600 hover:text-pink-500 font-medium">
        ...
        checkoutBtn.addEventListener('click', function () {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = '{{ route("template1.index1.customer", ["headerFooterId" => $headerFooter->id]) }}';
                } else {
