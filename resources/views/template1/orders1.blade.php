                        ...
                        <div class="divide-y divide-gray-200">
                            @foreach($order->products as $orderProduct)
                                <div class="flex flex-col sm:flex-row items-start sm:items-center py-4">
                                    <a href="{{ route('template1.single-product1.customer', ['headerFooterId' => $headerFooter->id, 'productId' => $orderProduct->product->id]) }}" class="w-24 h-24 sm:w-20 sm:h-20 flex-shrink-0 overflow-hidden rounded-md border border-gray-200 mb-4 sm:mb-0">
