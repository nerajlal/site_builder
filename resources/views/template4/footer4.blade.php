  ...
  <footer class="bg-[#faf9f7] text-gray-800 py-12 px-6 border-t border-gray-200">
    <div class="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">New Arrivals</a></li>
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">Best Sellers</a></li>
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">Sale</a></li>
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">Gift Cards</a></li>
        </ul>
      </div>
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">Shipping & Returns</a></li>
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">FAQ</a></li>
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">Personal Styling</a></li>
        </ul>
      </div>
      <div>
        <h5 class="font-semibold text-lg mb-4">Company</h5>
        <ul class="space-y-2">
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">About Us</a></li>
          <li><a href="#" class="text-gray-600 hover:text-purple-600 transition">Careers</a></li>
