        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-lg overflow-hidden boutique-card">
                    <div class="relative">
                        ...
                        <div class="aspect-square bg-pink-50 flex items-center justify-center">
                            <img src="https://images.unsplash.com/photo-1594223274512-ad4803739b7c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80" alt="Chic Summer Dress" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <div class="p-4">
            ...
            <a href="#" class="block">
                <div class="bg-white rounded-lg overflow-hidden boutique-card">
                    <div class="relative">
                        <div class="aspect-square bg-pink-50 flex items-center justify-center">
                            <img src="https://images.unsplash.com/photo-1543163521-1bf539c55dd2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Classic Leather Handbag" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <div class="p-4">
            ...
            <a href="#" class="block">
                <div class="bg-white rounded-lg overflow-hidden boutique-card">
                    <div class="relative">
                        ...
                        <div class="aspect-square bg-pink-50 flex items-center justify-center">
                            <img src="https://images.unsplash.com/photo-1434389677669-e08b4cac3105?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=705&q=80" alt="Printed Silk Scarf" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <div class="p-4">
            ...
            <a href="#" class="block">
                <div class="bg-white rounded-lg overflow-hidden boutique-card">
                    <div class="relative">
                        <div class="aspect-square bg-pink-50 flex items-center justify-center">
                            <img src="https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=698&q=80" alt="Elegant High Heels" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <div class="p-4">
