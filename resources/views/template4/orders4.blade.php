                        ...
                        <div class="divide-y divide-gray-200">
                            @foreach($order->products as $orderProduct)
                                <div class="flex items-center py-4">
                                    <a href="{{ route('template4.single-product4.customer', ['headerFooterId' => $headerFooter->id, 'productId' => $orderProduct->product->id]) }}" class="w-20 h-20 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
