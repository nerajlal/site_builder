            ...
            <div class="space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-center space-x-8 pt-4">
                        <button class="flex items-center space-x-2 text-gray-400 hover:text-primary transition-colors" onclick="toggleWishlist(this)" data-product-id="{{ $product->id }}">
        ...
        <div class="mt-16">
            <div class="border-b border-gray-700">
                <nav class="-mb-px flex space-x-8 overflow-x-auto">
                    ...
                    <button class="tab-btn py-4 px-1 border-b-2 border-transparent text-gray-400 hover:text-white whitespace-nowrap" onclick="showTab('fit')">Fit & Materials</button>
                    <button class="tab-btn py-4 px-1 border-b-2 border-transparent text-gray-400 hover:text-white whitespace-nowrap" onclick="showTab('reviews')">Reviews (128)</button>
                    <button class="tab-btn py-4 px-1 border-b-2 border-transparent text-gray-400 hover:text-white whitespace-nowrap" onclick="showTab('shipping')">Shipping & Returns</button>
                    <button class="tab-btn py-4 px-1 border-b-2 border-transparent text-gray-400 hover:text-white whitespace-nowrap" onclick="showTab('faq')">FAQ</button>
                </nav>
            </div>
            ...
            <div class="mt-8">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="grid md:grid-cols-3 gap-8">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center space-x-2">
                                        <span class="text-sm w-8 text-gray-300">5★</span>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span class="text-sm w-8 text-gray-300">4★</span>
                                        <div class="flex-1 bg-gray-700 rounded-full h-2">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span class="text-sm w-8 text-gray-300">3★</span>
                                        <div class="flex-1 bg-gray-700 rounded-full h-2">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span class="text-sm w-8 text-gray-300">2★</span>
                                        <div class="flex-1 bg-gray-700 rounded-full h-2">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span class="text-sm w-8 text-gray-300">1★</span>
                                        <div class="flex-1 bg-gray-700 rounded-full h-2">
                        ...
                        <!-- Review Filters -->
                        <div class="flex flex-wrap gap-2 py-4 border-y border-gray-700">
                            <button class="px-4 py-2 bg-primary text-white rounded-full text-sm">All Reviews</button>
                            <button class="px-4 py-2 border border-gray-600 rounded-full text-sm text-gray-300 hover:bg-gray-700">With Photos (45)</button>
                            <button class="px-4 py-2 border border-gray-600 rounded-full text-sm text-gray-300 hover:bg-gray-700">Size M (38)</button>
                            <button class="px-4 py-2 border border-gray-600 rounded-full text-sm text-gray-300 hover:bg-gray-700">Size L (29)</button>
                            <button class="px-4 py-2 border border-gray-600 rounded-full text-sm text-gray-300 hover:bg-gray-700">Fit: True to Size</button>
                        </div>
                            ...
                            <div class="border-b border-gray-700 pb-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-gray-300 mb-3">Beautiful dress with excellent quality! The fabric is soft and breathable, perfect for summer weather. The floral print is vibrant and the fit is just right. Highly recommend!</p>
                                        

                                        <!-- Review Tags -->
                                        <div class="flex flex-wrap gap-2 mb-3">
                                            <span class="px-2 py-1 bg-green-800 text-green-300 rounded-full text-xs">True to Size</span>
                                            <span class="px-2 py-1 bg-blue-800 text-blue-300 rounded-full text-xs">Great Quality</span>
                                            <span class="px-2 py-1 bg-purple-800 text-purple-300 rounded-full text-xs">Comfortable</span>
                                        </div>
                            ...
                            <div class="border-b border-gray-700 pb-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-gray-300 mb-3">Good quality dress, colors are vibrant as shown in pictures. The length is perfect for midi style. Only issue is that it wrinkles easily, but overall satisfied with the purchase.</p>
                                        
                                        <div class="flex flex-wrap gap-2 mb-3">
                                            <span class="px-2 py-1 bg-green-800 text-green-300 rounded-full text-xs">True to Size</span>
                                            <span class="px-2 py-1 bg-orange-800 text-orange-300 rounded-full text-xs">Wrinkles Easily</span>
                                        </div>
                            ...
                            <div class="border-b border-gray-700 pb-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-gray-300 mb-3">Absolutely love this dress! Perfect for summer occasions. The fabric is breathable and the cut is flattering. Received many compliments wearing this. Will definitely order in other colors.</p>
                                        
                                        <div class="flex flex-wrap gap-2 mb-3">
                                            <span class="px-2 py-1 bg-green-800 text-green-300 rounded-full text-xs">Perfect Fit</span>
                                            <span class="px-2 py-1 bg-blue-800 text-blue-300 rounded-full text-xs">Breathable</span>
                                            <span class="px-2 py-1 bg-purple-800 text-purple-300 rounded-full text-xs">Flattering</span>
                                        </div>
                ...
                <div id="shipping" class="tab-content hidden">
                    ...
                    <div class="mt-8 bg-gray-800 p-6 rounded-lg">
                        ...
                        <div class="grid md:grid-cols-4 gap-4 text-sm text-gray-300">
                            <div class="text-center">
                                ...
                                <p class="text-gray-400">Via WhatsApp or email within 7 days</p>
                            </div>
                            <div class="text-center">
                                ...
                                <p class="text-gray-400">We'll arrange free pickup from your location</p>
                            </div>
                            <div class="text-center">
                                ...
                                <p class="text-gray-400">We verify the product condition</p>
                            </div>
                            <div class="text-center">
                                ...
                                <p class="text-gray-400">Process completed within 3-5 days</p>
                            </div>
                        </div>
                    </div>
                </div>
