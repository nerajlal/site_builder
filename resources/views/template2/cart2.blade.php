                        ...
                        <div id="cart-items-container" class="divide-y divide-gray-800">
                            @foreach($cartItems as $item)
                                <div class="cart-item flex items-center py-6" data-id="{{ $item->id }}">
                                    <a href="{{ route('product.show', ['headerFooterId' => $headerFooter->id, 'productId' => $item->product->id]) }}" class="w-24 h-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-700">
                                    ...
                                    <div class="ml-4 flex flex-1 flex-col">
                                        <div>
                                            <div class="flex justify-between text-base font-medium text-white">
                                                <h3>
                                                    <a href="{{ route('product.show', ['headerFooterId' => $headerFooter->id, 'productId' => $item->product->id]) }}" class="hover:text-pink-500">{{ $item->product->name }}</a>
                                                </h3>
        ...
        checkoutBtn.addEventListener('click', function () {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = '{{ route("template2.index2.customer", ["headerFooterId" => $headerFooter->id]) }}';
                } else {
