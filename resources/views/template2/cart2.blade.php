        ...
        <div class="flex flex-col lg:flex-row -mx-4">
                        ...
                        <div id="cart-items-container" class="divide-y divide-gray-200">
                            @foreach($cartItems as $item)
                                <div class="cart-item flex items-center py-6" data-id="{{ $item->id }}">
                                    <a href="{{ route('template2.single-product2.customer', ['headerFooterId' => $headerFooter->id, 'productId' => $item->product->id]) }}" class="w-24 h-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                                    ...
                                    <div class="ml-4 flex flex-1 flex-col">
                                        <div>
                                            <div class="flex justify-between text-base font-medium text-gray-900">
                                                <h3>
                                                    <a href="{{ route('template2.single-product2.customer', ['headerFooterId' => $headerFooter->id, 'productId' => $item->product->id]) }}">{{ $item->product->name }}</a>
                                                </h3>
            ...
            <div class="w-full lg:w-1/3 px-4 mt-8 lg:mt-0">
                <div class="bg-white rounded-lg shadow-lg p-6 sticky top-24">
                    ...
                    <a href="{{ route('template2.product2.customer', ['headerFooterId' => $headerFooter->id]) }}" class="block text-center mt-4 text-pink-600 hover:text-pink-500 font-medium">
