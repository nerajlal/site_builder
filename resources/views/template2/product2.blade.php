    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-white">
        ...
        <div class="flex items-center justify-between mb-8 bg-black p-4 rounded-lg border border-gray-800">
            <form action="{{ url()->current() }}" method="GET" class="flex items-center space-x-4">
                <div class="relative">
                    <select name="sort" onchange="this.form.submit()" class="px-4 py-2 border border-gray-700 rounded-lg hover:border-yellow-600 hover:text-yellow-600 transition-colors bg-black text-white">
                ...
                <div class="relative">
                    <input type="number" name="min_price" value="{{ request('min_price') }}" placeholder="Min Price" class="px-4 py-2 border border-gray-700 rounded-lg bg-black text-white w-32">
                </div>
                <div class="relative">
                    <input type="number" name="max_price" value="{{ request('max_price') }}" placeholder="Max Price" class="px-4 py-2 border border-gray-700 rounded-lg bg-black text-white w-32">
                </div>
                <button type="submit" class="px-4 py-2 bg-yellow-600 text-black rounded-lg hover:bg-yellow-700">Filter</button>
            </form>
        </div>
