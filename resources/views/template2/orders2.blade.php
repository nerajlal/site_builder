                                ...
                                <div class="py-4">
                                    ...
                                    <div class="ml-24 mt-2 pl-2 border-l border-gray-700">
                                        @foreach($items as $item)
                                            <div class="text-sm text-gray-400 py-1 flex justify-between">
                                                <div>
                                                    @if(isset($item->options['color']))
                                                        <span>Color: <span class="font-medium text-gray-200">{{ $item->options['color'] }}</span></span>
                                                    @endif
                                                    @if(isset($item->options['size']))
                                                        <span class="ml-2">Size: <span class="font-medium text-gray-200">{{ $item->options['size'] }}</span></span>
                                                    @endif
