...
Route::get('/site/{headerFooterId}', [WebsiteViewController::class, 'show'])->name('site.show');
...
Route::get('/product/{headerFooterId}/{productId}', [UnifiedProductController::class, 'showSingle'])->name('product.show');
